      ...
      <main className="flex-1">
        ...
        <section id="contact" className="bg-[#111111] text-white">
          <div className="mx-auto max-w-[1100px] px-6 py-24 text-center">
            ...
            <p className="text-base text-[#999] max-w-[480px] mx-auto mb-10 leading-relaxed">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block border-2 border-[#444] text-[#999] px-7 py-[14px] text-xs font-bold uppercase tracking-[2px] hover:border-[#999] hover:text-white transition-colors"
              >
                LinkedIn
              </a>
              <a
